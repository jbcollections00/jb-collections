      ...
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="overflow-hidden rounded-[2rem] bg-gradient-to-r from-sky-500 via-blue-600 to-violet-600 p-6 text-white shadow-lg">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0 max-w-2xl">
              ...
              <h1 className="text-3xl font-extrabold md:text-4xl">Premium Membership</h1>
            </div>
        ...
        <section className="rounded-2xl bg-white p-6 shadow">
          ...
          <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200">
            ...
            >
              <span className="text-xl font-bold text-slate-900">Premium Payment Details</span>
              <span className="text-lg text-slate-600">{showPaymentDetails ? "▲" : "▼"}</span>
            </button>
              ...
              <div className="space-y-5 border-t border-slate-200 p-5">
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-white p-5 text-center">
                    <h3 className="mb-4 text-2xl font-bold text-slate-900">Scan QR Code</h3>
