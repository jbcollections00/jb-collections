...
function getPreviewImage(file: FileItem) {
  ...
  if (isImageFile(file.file_url)) return file.file_url
  return null
}
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5">
              {paginatedFiles.map((file) => {
                ...
                return (
                  <div
                    key={file.id}
                    className="group overflow-hidden rounded-[24px] border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl sm:rounded-[28px]"
                  >
                    ...
                    <div className="px-4 pb-4 pt-3">
                      <h3
                        className="mb-3 line-clamp-2 min-h-[48px] text-center text-lg font-extrabold leading-tight text-slate-900 sm:text-xl"
                      ...
                      <button
                        ...
                        className="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-600 px-4 py-3 text-sm font-bold text-white transition hover:from-sky-600 hover:via-blue-700 hover:to-indigo-700"
                      >
                        Download Now
                      </button>
                    </div>
