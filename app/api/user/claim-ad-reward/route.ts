...
// Set reward amount (e.g., 10 JB Coins per ad view)
...
export async function POST() {
  try {
    ...
    // 2. Fetch current profile to get current coins
    ...
    // 4. (Optional) Log transaction history if you have a coin history table
