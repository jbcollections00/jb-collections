...
export default function ProfilePageClient() {
  ...
  if (loading) {
    return (
      <>
        <SiteHeader />
        <div className="min-h-screen overflow-x-hidden bg-slate-950 pt-24 sm:pt-28">
            ...
            <div className="relative px-4 py-6 sm:px-8 lg:px-10">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                <button
                  ...
                  className="w-full rounded-2xl bg-white px-5 py-3 text-sm font-black text-slate-900 transition hover:scale-[1.02] sm:w-auto"
                >
                ...
                {profile?.username ? (
                  <Link
                    ...
                    className="w-full rounded-2xl border border-white/20 bg-white/10 px-5 py-3 text-sm font-black text-white transition hover:bg-white/15 sm:w-auto"
                  >
                    View Public Profile
                  </Link>
                ) : null}
