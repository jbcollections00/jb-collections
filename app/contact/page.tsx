...
export const metadata = {
  ...
  description:
    "Contact JB Collections for account concerns, membership, coins, rewards, password recovery, and support.",
}
          ...
          <div className="relative">
            ...
            <div className="relative px-5 py-10 sm:px-8 sm:py-12 lg:px-10">
              ...
              <p className="mt-4 max-w-3xl text-base leading-8 text-slate-300">
                ...
                rewards, password recovery, or other concerns? We are here to
                assist you.
              </p>
            </div>
          </div>
